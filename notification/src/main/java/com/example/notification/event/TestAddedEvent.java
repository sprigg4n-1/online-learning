...
public class TestAddedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 5150956614074584413L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"TestAddedEvent\",\"namespace\":\"com.example.notification.event\",\"fields\":[{\"name\":\"testNumber\",\"type\":\"string\"}]}");
   ...
   */
  public static com.example.notification.event.TestAddedEvent.Builder newBuilder() {
    return new com.example.notification.event.TestAddedEvent.Builder();
  }
   ...
   * @return A new TestAddedEvent RecordBuilder
   */
  public static com.example.notification.event.TestAddedEvent.Builder newBuilder(com.example.notification.event.TestAddedEvent.Builder other) {
    if (other == null) {
      return new com.example.notification.event.TestAddedEvent.Builder();
    } else {
      return new com.example.notification.event.TestAddedEvent.Builder(other);
    }
  }
   ...
   * @return A new TestAddedEvent RecordBuilder
   */
  public static com.example.notification.event.TestAddedEvent.Builder newBuilder(com.example.notification.event.TestAddedEvent other) {
    if (other == null) {
      return new com.example.notification.event.TestAddedEvent.Builder();
    } else {
      return new com.example.notification.event.TestAddedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<TestAddedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.example.notification.event.TestAddedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.example.notification.event.TestAddedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.testNumber)) {
        this.testNumber = data().deepCopy(fields()[0].schema(), other.testNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.notification.event.TestAddedEvent.Builder setTestNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.example.notification.event.TestAddedEvent.Builder clearTestNumber() {
      testNumber = null;
